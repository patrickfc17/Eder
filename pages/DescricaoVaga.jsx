...
const { dark } = defaults.colors

export const DescricaoVaga = () => {
  return (
    <SafeAreaProvider>
      <SafeAreaView>
        <ScrollView contentContainerStyle={styles.container}>
          ...
          <View style={styles.descricaoContainer}>
            ...
            <Text style={styles.texto}>
              Somos uma empresa líder em inovação tecnológica, dedicada a criar
              soluções de software que transformam desafios complexos em
            ...
            <Text style={styles.texto}>
              • Desenvolver e manter sistemas escaláveis e de alta performance.
              {'\n'}• Colaborar com equipes multidisciplinares (Product, UX, QA)
              para definir requisitos e entregar soluções alinhadas às
              necessidades dos clientes.{'\n'}• Participar de revisões de código
              e promover boas práticas de programação.{'\n'}• Resolver problemas
              técnicos e otimizar desempenho de aplicações.{'\n'}• Acompanhar
              tendências tecnológicas e propor melhorias em produtos existentes.
            ...
            <Text style={styles.texto}>
              ...
              {'\n'}• Familiaridade com plataformas de nuvem (AWS, Azure, Google
            ...
            <Text style={styles.texto}>
              ...
              (JUnit, Selenium).{'\n'}• Contribuições em projetos open source ou
              portfólio público (GitHub, GitLab).{'\n'}• Certificações em cloud
              (AWS Certified, Azure Developer).
            </Text>

            <Text style={styles.titulo}>Benefícios:</Text>
            <Text style={styles.texto}>
              • Salário competitivo + bônus por desempenho.{'\n'}• Flexibilidade
              de horário e trabalho remoto/híbrido.{'\n'}• Plano de saúde e
              odontológico.{'\n'}• Acesso a cursos, conferências e mentoria para
              desenvolvimento profissional.{'\n'}• Stock options e programa de
              participação nos lucros.{'\n'}• Programas de bem-estar (yoga,
              parcerias com academias).{'\n'}• Eventos de integração e cultura
              descontraída.
            </Text>
          </View>
